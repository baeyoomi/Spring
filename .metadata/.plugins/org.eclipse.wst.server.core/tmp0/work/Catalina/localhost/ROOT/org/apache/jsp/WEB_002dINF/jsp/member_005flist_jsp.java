 ...
 * Generated at: 2023-09-08 08:27:54 UTC
...
public final class member_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(part != null && part.equals("tel") ){
      ...
      out.write("		</thead>\r\n");
      out.write("		<tbody>\r\n");
      out.write("		<!-- database에 내용이 출력 파트 -->\r\n");
      out.write("		\r\n");
      out.write("		<!-- 배열 값 중 첫번째 아이디값을 확인하여 값이 없을 경우에 대한 조건 -->\r\n");
      out.write("		");
 if(member_data.get(0).get(1) == "") { 
      ...
      out.write("\r\n");
      out.write("	<br><br>\r\n");
      out.write("	<form id=\"f\" method=\"get\" action=\"./spring6ok.do\" onsubmit=\"return idsearch()\">\r\n");
      out.write("	검색 : \r\n");
      out.write("	<!-- 검색시 분류 설정을 하여 검색 되도록 함 -->\r\n");
      ...
      out.write("</body>\r\n");
      out.write("<script>\r\n");
      out.write("//var word = \"장바구니의 정보를 출력하는 페이지 바구니\";\r\n");
      out.write("//var word2 = word.trim(); //앞,뒤에 공백만 삭제\r\n");
      out.write("//var word2 = word.replace(\" \",\"\");  //문장 전체중 첫번째 나오는 해당 단어만 변경\r\n");
      out.write("//var word2 = word.replaceAll(\"바구니\",\"aaa\"); //문장 전체의 해당 단어를 변경 (나중에 욕설같은거 막을때 쓸 수 있음)\r\n");
      out.write("//console.log(word2);\r\n");
      out.write("\r\n");
      out.write("	//검색한 단어를 입력값에 유지시키는 스크립코드\r\n");
      out.write("	var wd = decodeURI(window.location.search);\r\n");
      out.write("	//console.log(wd);  // ?part=id&search=hanpak33\r\n");
      out.write("	if(wd != \"\"){\r\n");
